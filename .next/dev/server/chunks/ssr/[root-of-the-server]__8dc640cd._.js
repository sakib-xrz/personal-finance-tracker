...
/* __next_internal_action_entry_do_not_use__ [{"40051826376a93c82271df604dec916490ec7fa869":"getTransactions","406248439e02a48fa56465edd9c0b29e36560f7d30":"getTransaction","40d87f6f6982ce78e04ff6615b06286b60f7c41892":"createTransaction","40e993d5248b4b8df9c8f17d3ed787765adac02f2b":"getTransactionStats","40f77a286404cbef10c00701a25590f2629957f74b":"deleteTransaction","608f978a79c2bec7623c716cb9f0346df8e81a7f29":"updateTransaction"},"",""] */ __turbopack_context__.s([
    "createTransaction",
    ()=>createTransaction,
    "deleteTransaction",
    ()=>deleteTransaction,
...
// Helper function to get transactions with caching
async function getTransactionsFromDB(filters) {
    const where = {};
    if (filters.type && [
        "income",
        "expense",
    ...
    const transactions = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].transaction.findMany({
        where,
        orderBy: {
            date: "desc"
        }
    });
    return transactions.map(__TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["formatTransaction"]);
}
async function getTransactions(filters) {
    try {
        const cacheKey = `transactions-${JSON.stringify(filters || {})}`;
        const cachedTransactions = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["unstable_cache"])(async ()=>getTransactionsFromDB(filters || {}), [
            cacheKey
        ], {
            tags: [
                CACHE_TAG_TRANSACTIONS
            ],
            revalidate: 3600
        });
        const transactions = await cachedTransactions();
        return {
            success: true,
            data: transactions
        };
...
async function getTransaction(id) {
    try {
        const cachedTransaction = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["unstable_cache"])(async ()=>{
            const transaction = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].transaction.findUnique({
                where: {
                    id
                }
            });
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["formatTransaction"])(transaction);
        }, [
            `transaction-${id}`
        ], {
            tags: [
                CACHE_TAG_TRANSACTION(id),
                CACHE_TAG_TRANSACTIONS
            ],
            revalidate: 3600
        });
        const transaction = await cachedTransaction();
        if (!transaction) {
            return {
                success: false,
...
async function createTransaction(data) {
    try {
        ...
        const transaction = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].transaction.create({
            data: {
                title,
                amount,
                date: new Date(date),
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidateTag"])(CACHE_TAG_TRANSACTIONS);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidateTag"])(CACHE_TAG_STATS);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidateTag"])(CACHE_TAG_TRANSACTION(transaction.id));
        return {
            success: true,
...
async function updateTransaction(id, data) {
    try {
        ...
        const existingTransaction = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].transaction.findUnique({
            where: {
                id
            }
        });
        ...
        const transaction = await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].transaction.update({
            where: {
                id
            },
            data: updateData
        ...
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidateTag"])(CACHE_TAG_TRANSACTIONS);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidateTag"])(CACHE_TAG_STATS);
        (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["revalidateTag"])(CACHE_TAG_TRANSACTION(id));
        return {
            success: true,
            data: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$api$2d$utils$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["formatTransaction"])(transaction)
        };
...
async function deleteTransaction(id) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$prisma$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["prisma"].transaction.delete({
            where: {
                id
            }
        });
...
// Helper function to get statistics with caching
async function getStatsFromDB(month) {
    const where = {};
    if (month) {
        where.month = month;
    }
...
async function getTransactionStats(month) {
    try {
        const cacheKey = `transaction-stats-${month || "all"}`;
        const cachedStats = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$cache$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["unstable_cache"])(async ()=>getStatsFromDB(month), [
            cacheKey
        ], {
            tags: [
                CACHE_TAG_STATS,
...
(0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$webpack$2f$loaders$2f$next$2d$flight$2d$loader$2f$server$2d$reference$2e$js__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["registerServerReference"])(getTransactions, "40051826376a93c82271df604dec916490ec7fa869", null);
...
__turbopack_context__.s([
    "40051826376a93c82271df604dec916490ec7fa869",
...
//# sourceMappingURL=%5Broot-of-the-server%5D__8dc640cd._.js.map